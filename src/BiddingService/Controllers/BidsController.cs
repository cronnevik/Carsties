...
[ApiController]
[Route("api/[controller]")] // controller => first part of classname => "Bids"
public class BidsController : ControllerBase
{
    ...
    public async Task<ActionResult<List<BidDto>>> GetBidsForAuction(string auctionId)
    {
        ...
        return bids.Select(_mapper.Map<BidDto>).ToList(); // project into BidDto object and pass it into a list
    }
}
