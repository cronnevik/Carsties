...
public class AuctionControllerTests
{
    ...
    public AuctionControllerTests()
    {
        ...
        // Not mocking mapper. Uses it as is
    ...
    public async Task GetAuctionById_WithValidGuid_ReturnsAuction()
    {
        ...
        _auctionRepo.Setup(repo => repo.GetAuctionbByIdAsync(It.IsAny<Guid>())).ReturnsAsync(auction);
    ...
    {
        // arrange
        _auctionRepo.Setup(repo => repo.GetAuctionbByIdAsync(It.IsAny<Guid>())).ReturnsAsync(value: null);
